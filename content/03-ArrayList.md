...
modified: 2025-08-29T10:18:54.5454+08:00
---
## Properties
...
| Type      | Get the length                                                              | Get an element    |
| --------- | --------------------------------------------------------------------------- | ----------------- |
| String    | str.length()                                                                | substring(i, i+1) |
| Array     | arr.length<br>(this is an attribute, not a method, so no brackets after it) | arr\[i\]          |
...
**avoid skipping elements**. There are 3 ways:
1. ==if-else==
