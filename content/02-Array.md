...
modified: 2025-08-29T10:16:47.4747+08:00
---
...
## For-each loop
- used for array and [[03-ArrayList|arraylist]]
...
```
- 其中 line 1 有两种写法
	1. 一种如上：把初始值定为 array 里的一个数
	2. 另一种如下：取 Integer class 的最小值 （找 minimum 时取 MAX_VALUE）
```java
