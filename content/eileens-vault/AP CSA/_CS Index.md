...
[[Bill Barnum Notes#Objects|Objects]]

[[Inheritance]]

[[Inheritance#Polymorphism 多态|Polymorphism 多态]]
...
**Unit 5. Writing Classes:** Class Definitions, Fields, Constructors, Instance Methods, Accessors and Mutators, `this` Keyword, Encapsulation (`public`, `private`), Method Overloading, Class Invariants

**Unit 6. Arrays:** Declaring and Instantiating Arrays, Accessing and Modifying Elements, Array Bounds and Errors, Iterating through Arrays, Aggregation Patterns (sum, max, min, average), Searching and Filtering

**Unit 7. ArrayList:** Declaring and Instantiating ArrayLists, Adding/Accessing/Modifying/Removing Elements, ArrayList Methods (`add`, `get`, `set`, `remove`, `size`), Autoboxing with Wrapper Classes, Iterating through ArrayLists

**Unit 8. 2D Arrays:** Declaring and Instantiating 2D Arrays, Accessing and Modifying Elements, Nested Loop Traversal, Row-Major and Column-Major Order, Aggregation in 2D Arrays

**Unit 9. Inheritance:** [[Inheritance#key word extends|`extends` Keyword]], [[Inheritance#Property|Method Overriding]], [[Inheritance#key word super|Using `super`]], Constructor Chaining, [[Inheritance#Polymorphism 多态|Polymorphism]], Dynamic Method Binding, `Object` Class (`toString`, `equals`), Abstract Classes and Methods

**Unit 10. Recursion:** Recursive Method Structure, Base Case and Recursive Case, Tracing Recursive Calls, Infinite Recursion, Recursion vs Iteration, Recursive Array and ArrayList Processing